...
{
    if (money >= 350) mental_condition += 20, money -= 350, HP-=5.0f;
    else
    {
...
{
    if (money >= 450) mental_condition += 22, money -= 450, HP-=7.0f;
    else
    {
...
{
    if (money >= 3000) mental_condition += 35, money -= 3000, HP-=10.0f;
    else
    {
